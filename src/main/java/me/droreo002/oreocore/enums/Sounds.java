...
public enum Sounds {
    ...
    /**
     * Get the sound object from a string
     *
     * @param s : The string
     * @return the sounds object if there's any match, null otherwise
     */
    public static Sounds fromString(String s) {
        for (Sounds sound : values()) {
            for (String ver : sound.versionDependentNames) {
                if (ver.equalsIgnoreCase(s)) return sound; // Correct
            }
        }
        return null;
    }
