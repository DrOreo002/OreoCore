...
public class ImageMessage {
    ...
    private String[] toImgMessage(ChatColor[][] colors) {
        ...
        ChatColor transparencyColor = ChatColor.GRAY;
    ...
    private ChatColor getClosestChatColor(Color color) {
        ...
        for (Map.Entry<ChatColor, Color> entry : graysMap.entrySet()) {
    ...
    private class TooWideException extends Exception {

        TooWideException(String message) {
            super(message);
        }

        TooWideException(int i) {
            super("This image is too wide! (Width :" + i + ")");
        }
    }
}
