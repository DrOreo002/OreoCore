...
public final class StringUtils {
     ...
     * @return the wave as list (per frame)
     */
    public static List<String> colorWaveString(String text, String waveColor, String stringBaseColor) {
     ...
     */
    public static List<String> colorFillString(String text, String fillColor, String stringBaseColor) {
        final List<String> s = new ArrayList<>();
        text = stripColor(text);
        // Clone the list
        for (int i = 0; i < text.toCharArray().length; i++) {
