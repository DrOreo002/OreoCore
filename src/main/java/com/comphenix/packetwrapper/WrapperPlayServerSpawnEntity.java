...
public class WrapperPlayServerSpawnEntity extends AbstractPacket {
	...
	/**
	 * Represents the different wrapper types.
	 * 
	 * @author Kristian
	 */
	public static class ObjectTypes extends IntEnum {
		...
		/**
		 * Retrieve an instance of the wrapper types enum.
		 * 
	...
	/**
	 * Retrieve the x position of the wrapper.
	 * <p>
	...
	/**
	 * Set the x position of the wrapper.
	 * 
	 * @param value - new value.
	 */
	...
	/**
	 * Retrieve the y position of the wrapper.
	 * <p>
	 * Note that the coordinate is rounded off to the nearest 1/32 of a meter.
	 * 
	...
	/**
	 * Set the y position of the wrapper.
	 * 
	 * @param value - new value.
	 */
	...
	/**
	 * Retrieve the z position of the wrapper.
	 * <p>
	 * Note that the coordinate is rounded off to the nearest 1/32 of a meter.
	 * 
	...
	/**
	 * Set the z position of the wrapper.
	 * 
	 * @param value - new value.
	 */
	...
	/**
	 * Set the yaw of the wrapper spawned.
	 * 
	 * @param value - new yaw.
	 */
	...
	/**
	 * Retrieve the type of wrapper. See {@link ObjectTypes}
	 * 
	...
	/**
	 * Set the type of wrapper. See {@link ObjectTypes}.
	 * 
	 * @param value - new value.
	 */
	...
	/**
	 * Retrieve wrapper data.
	 * <p>
	 * The content depends on the wrapper type:
